...
#> Rows: 26
#> Columns: 12
#> $ incidence_start_date         <date> 2008-01-01, 2009-01-01, 2010-01-01, 2011…
#> $ denominator_sex              <chr> "Female", "Female", "Female", "Female", "…
#> $ analysis_interval            <chr> "years", "years", "years", "years", "year…
#> $ outcome_cohort_name          <chr> "cohort_1", "cohort_1", "cohort_1", "coho…
#> $ outcome_count                <int> 14, 10, 14, 3, 4, 1, 1, 3, 1, 51, 13, 14,…
#> $ person_years                 <dbl> 234.813, 233.057, 209.706, 160.778, 132.9…
#> $ crude_rate                   <dbl> 5962.1912, 4290.7958, 6676.0131, 1865.926…
#> $ crude_rate_95CI_lower        <dbl> 2839.0618, 1631.3819, 3178.9678, -245.529…
#> $ crude_rate_95CI_upper        <dbl> 9085.320, 6950.210, 10173.058, 3977.383, …
#> $ standardised_rate            <dbl> 6028.316, 4276.532, 6868.422, 1738.195, 3…
#> $ standardised_rate_95CI_lower <dbl> 2797.2085, 1527.5585, 3158.1231, -308.713…
#> $ standardised_rate_95CI_upper <dbl> 9259.423, 7025.506, 10578.720, 3785.103, …
```
